 ...
 * @property \cover\web\View $view The view object that can be used to render views or view files. Note that the
...
class Widget extends Component implements ViewContextInterface
{
    ...
    public static function begin($config = [])
    {
        ...
        /* @var $widget Widget */
        $widget = Cover::createObject($config);
        static::$stack[] = $widget;
     ...
     * @return \cover\web\View the view object that can be used to render views or view files.
     */
