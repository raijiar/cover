 ...
 *
 * Check implementation of [[\cover\filters\AccessControl]], [[\cover\filters\PageCache]] and [[\cover\filters\HttpCache]] as examples on how to use it.
 *
...
class ActionFilter extends Behavior
{
     ...
     * and controller IDs.
     *
     * Since version 1.0 action IDs can be specified as wildcards, e.g. `site/*`.
     *
     * @see except
     */
    public $only;
