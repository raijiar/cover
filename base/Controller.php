 ...
 * read-only.
 * @property View|\cover\web\View $view The view object that can be used to render views or view files.
...
class Controller extends Component implements ViewContextInterface
{
     ...
     * ```
     *
     * [[\Cover::createObject()]] will be used later to create the requested action
    ...
    public function runAction($id, $params = [])
    {
        ...
        Cover::debug('Route to run: ' . $action->getUniqueId(), __METHOD__);

        if (Cover::$app->requestedAction === null) {
            Cover::$app->requestedAction = $action;
        }
    ...
    public function run($route, $params = [])
    {
        ...
        return Cover::$app->runAction(ltrim($route, '/'), $params);
    }
    ...
    public function createAction($id)
    {
        ...
        if (isset($actionMap[$id])) {
            return Cover::createObject($actionMap[$id], [$id, $this]);
     ...
     * @return View|\cover\web\View the view object that can be used to render views or view files.
     */
    public function getView()
    {
        if ($this->_view === null) {
            $this->_view = Cover::$app->getView();
        }
     ...
     * @param View|\cover\web\View $view the view object that can be used to render views or view files.
     */
    ...
    public function findLayoutFile($view)
    {
        ...
        if (strncmp($layout, '@', 1) === 0) {
            $file = Cover::getAlias($layout);
        } elseif (strncmp($layout, '/', 1) === 0) {
            $file = Cover::$app->getLayoutPath() . DIRECTORY_SEPARATOR . substr($layout, 1);
        } else {
