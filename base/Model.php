...
use cover\validators\RequiredValidator;
 ...
 *
 * @property \cover\validators\Validator[] $activeValidators The validators applicable to the current
 ...
 * @property ArrayObject|\cover\validators\Validator[] $validators All the validators declared in the model.
...
class Model extends Component implements StaticInstanceInterface, IteratorAggregate, ArrayAccess, Arrayable
{
     ...
     *
     * Cover also provides a set of [[Validator::builtInValidators|built-in validators]].
     ...
     *
     * The form name is mainly used by [[\cover\widgets\ActiveForm]] to determine how to name
     ...
     * ```
     *
     * @return ArrayObject|\cover\validators\Validator[] all the validators declared in the model.
     */
     ...
     * @return \cover\validators\Validator[] the validators applicable to the current [[scenario]].
     */
     ...
     * [[\cover\validators\RequiredValidator|required]] validation rule in the
     * current [[scenario]].
     *
     * Note that when the validator has a conditional validation applied using
     * [[\cover\validators\RequiredValidator::$when|$when]] this method will return
    ...
    {
        if (YII_DEBUG) {
            Cover::debug("Failed to set unsafe attribute '$name' in '" . get_class($this) . "'.", __METHOD__);
        }
    }
