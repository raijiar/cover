...
class Action extends Component
{
    ...
    public $id;
    /**
     * @var Controller|\cover\web\Controller|\cover\console\Controller the controller that owns this action
     */
    public $controller;
    ...
    public function runWithParams($params)
    {
        ...
        Cover::debug('Running action: ' . get_class($this) . '::run()', __METHOD__);
        if (Cover::$app->requestedParams === null) {
            Cover::$app->requestedParams = $args;
        }
        if ($this->beforeRun()) {
