...
use cover\base\UnknownClassException;
use cover\di\Container;
use cover\log\Logger;
 ...
 */
defined('COVER_ENV_PROD') or define('COVER_ENV_PROD', COVER_ENV === 'prod');
/**
 * Whether the the application is running in development environment.
 */
defined('COVER_ENV_DEV') or define('COVER_ENV_DEV', COVER_ENV === 'dev');
/**
 * Whether the the application is running in testing environment.
 */
defined('COVER_ENV_TEST') or define('COVER_ENV_TEST', COVER_ENV === 'test');
...
/**
 * BaseCover is the core helper class for the Cover framework.
 *
 * Do not use BaseCover directly. Instead, use its child class [[\Cover]] which you can replace to
 * customize methods of BaseCover.
 *
 */
class BaseCover
{
    /**
     * @var array class map used by the Cover autoloading mechanism.
    ...
    /**
     * @var \cover\console\Application|\cover\web\Application the application instance
     */
    public static $app;
    /**
     ...
     * @see setAlias()
     */
    public static $aliases = ['@cover' => __DIR__];
    /**
    ...
    public static function autoload($className)
    {
        ...
        if (COVER_DEBUG && !class_exists($className, false) && !interface_exists($className, false) && !trait_exists($className, false)) {
