...
use cover\base\ArrayAccessTrait;
...
abstract class BaseActiveFixture extends DbFixture implements \IteratorAggregate, \ArrayAccess, \Countable
{
    ...
    /**
     * @var \cover\db\ActiveRecord[] the loaded AR models
     */
    private $_models = [];
     ...
     * @return null|\cover\db\ActiveRecord the AR model, or null if the model cannot be found in the database
     * @throws \cover\base\InvalidConfigException if [[modelClass]] is not set.
     */
    public function getModel($name)
    {
        ...
        $row = $this->data[$name];
        /* @var $modelClass \cover\db\ActiveRecord */
